 ...
 * @return string
 */
function theme_university_get_main_scss_content($theme) {
    global $CFG;
    ...
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_university', 'preset', 0, '/', $filename))) {
 ...
 */
function theme_university_get_precompiled_css() {
    global $CFG;
 ...
 * @return array
 */
function theme_university_get_pre_scss($theme) {
    global $CFG;
