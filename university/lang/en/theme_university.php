...
$string['favicon_desc'] = 'Change the favicon for University. Images with a transparent background and 32px height will work best.  Allowed types: PNG, JPG, ICO';
...
$string['promotedtitledefault'] = 'Courses you may be interested in';
...
$string['pcourses'] = 'Courses you may be interested in';
...
$string['bannersettings'] = 'Banner image settings';
...
$string['websitedesc'] = 'Enter the URL of your own website. (i.e https://debonairtraining.com)';
$string['blog'] = 'Blog URL';
$string['blogdesc'] = 'Enter the URL of your institution blog. (i.e https://debonairtraining.com)';
$string['sociallink'] = 'Custom Social Link';
$string['sociallinkdesc'] = 'Enter the URL of your your custom social media link. (i.e https://debonairtraining.com)';
...
$string['generalcontentinfodesc'] = 'The options below help you customize the way content is displayed and turn on additional features for University.';
...
$string['sectionlayout_desc'] = 'Choose from the following topic/weekly section styles.  <a href="https://goo.gl/fMXzSo" target="_new">Instructions for University</a>';
...
$string['blockwidthuniversity'] = 'Block Column Width';
$string['blockwidthuniversity_desc'] = 'Adjust the width of the block column.';
...
$string['coursetilestyle_desc'] = 'When viewing course categories you can choose from the following styles to display courses. <a href="https://goo.gl/fMXzSo" target="_new">Instructions for University </a>';
...
$string['setting_navdrawersettings_desc'] = 'Enable the Boost nav drawer feature.  University does not require the nav drawer for navigation.  We have replaced it with a Jump-to-section dropdown. You may re-enable the nav drawer below.';
$string['shownavdrawer'] = 'Show Navdrawer';
$string['shownavdrawer_desc'] = 'University has eliminated the need for the nav drawer by utilizing a drop-down menu for in-course navigation.  If you must use the nav drawer you can check this box to re-enable it.';
...
* University > Custom Image Settings > Default Login Image can be used to change the background image for the login page. <br>
* University > Content Areas > Homepage Alert can be used to provide a notice on the top of the page. </b>';
...
// University Plugin Integration Enhancements.
$string['integrationinfo'] = 'Plugin Integrations';
$string['integrationinfo_desc'] = 'University can activate enhanced features and better integrate with certain plugins. The settings below will allow you to use the default plugin behavior or turn on advanced features that the developers of University have implemented.';
...
$string['collapsibletopics_desc'] = 'If you install the Collapsible Topics Format ( <a href="https://moodle.org/plugins/format_collapsibletopics">format_collapsibletopics</a> ) the University theme can provide an enhanced course format view and special styling that better integrates with the overall look and feel of University. Special care and attention has been developed to provide a smoother user experience for users of all ages and skills.';
