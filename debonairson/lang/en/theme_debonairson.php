...
// Theme strings.
$string['choosereadme'] = 'Debonairson provides a unique visual experience to the default Boost theme with customization features such as color choosers and enhanced homepage experience.';
$string['configtitle'] = 'Debonairson';
$string['pluginname'] = 'Debonairson';
...
$string['privacy:metadata'] = 'The Debonairson theme does not store any individual user data.';
