...
$PAGE->requires->js('/theme/debonairson/javascript/main.js');
$PAGE->requires->js('/theme/debonairson/javascript/modal.js');
$PAGE->requires->js('/theme/debonairson/javascript/utils.js');
