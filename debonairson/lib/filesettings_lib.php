...
function theme_debonairson_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('debonairson');
    }
 ...
 * @return string
 */
function theme_debonairson_get_setting($setting, $format = false) {
    global $CFG;
