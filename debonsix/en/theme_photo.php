...
$string['choosereadme'] = 'Theme debonsix is a child theme of Boost. It adds the ability to upload background debonsixs.';
// Name of the settings pages.
$string['configtitle'] = 'debonsix settings';
